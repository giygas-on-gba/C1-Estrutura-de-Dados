#include <stdio.h>
#include <stdlib.h>
#include <time.h> //Biblioteca para o gerador de números pseudo-aleatórios.
...
int main(int argc, char *argv[]) {
	...
	do {
		...
		d->size++; // aumento de número de nós na lista com descritor.
		count++; //contagem de iterações
		printf("%i ", p->info);
